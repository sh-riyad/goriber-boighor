            ...
            <form class="mt-10">
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="relative z-0">
                        <input type="text" name="name" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white-1000 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    ...
                    <div class="relative z-0">
                        <input type="text" name="email" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white-1000 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    ...
                    <div class="relative z-0 col-span-2">
                        <textarea name="message" rows="5" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white-1000 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" "></textarea>
                ...
                <Link to="/"><button type="submit" class="mt-5 rounded-md bg-gray-700 px-10 py-2 text-white">Send Message</button></Link>
            </form>
        </div>
    </div>
    )
